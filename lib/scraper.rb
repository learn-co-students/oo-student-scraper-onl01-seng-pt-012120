...
class Scraper
  ...
  def self.scrape_profile_page(profile_url)
    ...
    links = profile_page.css(".social-icon-container").children.css("a").map {|icon| icon.attribute('href').value}    # Gets all of the links
    links.each do |link|     # Grabs each individual link
